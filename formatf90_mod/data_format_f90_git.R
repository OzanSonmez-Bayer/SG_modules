...
source('/repos/ELBFA_GS_modules/formatf90_mod/JWAS_Model_dataformat_f90_git.R')
options(scipen = 999)
...
for (i in 1:length(TRAITS)){
  ...
  getoutput_f90(out=out0,dataset=dataset_uom,trait = trait_choosen, gg=gg4,n_gen=5)#
