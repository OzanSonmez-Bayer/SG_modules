...
#dhSP<-read_excel("/mnt/DH_processing/List of testers of PCM1 by season by year_InvBID_2021.xlsx",sheet = "all metadata_remedy",guess_max = 20000)
dhSP<- s3read_using(FUN = read_excel, object = 's3://veg-apd-sdi-predictiveanalytcs-prod-workspace/ycao1/ITG/Cucumber/Files_PCM/Files_PCM/List of testers of PCM1 by season by year_InvBID_2021.xlsx', sheet = "all metadata_remedy")
...
#### Parents Pairs
#dhSP1<-read_excel("/mnt/DH_processing/List of testers of PCM1 by season by year_InvBID_2021.xlsx",sheet = "all metadata_remedy",guess_max = 20000)
dhSP1<- s3read_using(FUN = read_excel, object = 's3://veg-apd-sdi-predictiveanalytcs-prod-workspace/ycao1/ITG/Cucumber/Files_PCM/Files_PCM/List of testers of PCM1 by season by year_InvBID_2021.xlsx', sheet = "all metadata_remedy")
dhSP1<-dhSP1%>%dplyr::filter(Season=="summer")
dhSP1<-dhSP1%>%dplyr::filter(Year=="2021")
...
#save(Allinbred1,file="/mnt/DH_processing/sql_pedigree_name_summer2021.Rdata")

#table(miss_inv3$id%in%Allinbred1$INPUT_PEDIGREE_NAME)
...
#save(Allinbred3,file="/mnt/DH_processing/sql_invbid_summer2021.Rdata")
#table(miss_inv5$id%in%Allinbred3$INPUT_BARCODE)

#x=as.character(notsql$id)
#max=10
#y=seq_along(notsql$id)
#invs2 <- split(x, ceiling(y/max))
#notsql2021sum=bar_inv_sql(list("I00879555060221877010000"))
...
load("/mnt/DH_processing/sql_invbid_summer2021.Rdata")
load("/mnt/DH_processing/sql_pedigree_name_summer2021.Rdata")
...
ids_par<-function(miss_inv5,inbredAll,inbredAll2,inb,dhSP1){
  ...
  #Y3_EUR-Y316-3049GY/EUR-Y315-7014GY:0064%0001.0005.	#Y3_(EUR-Y316-3049GY/EUR-Y315-7014GY:0064%0001.0005.)
  #Y3_EUR-Y318-1061GY/EUR-200-BANC-GY:0026%0001.	#Y3_(EUR-Y318-1061GY/EUR-200-BANC-GY:0026%0001.)
  #Y3_((24-218RZ:0028%0001.0001.0009)/EUR-Y214-2502GY:0053%@.0003) #Y3_(24-218RZ:0028%0001.0001.0009)/EUR-Y214-2502GY:0053%@.0003#	
  #Y3_((24-218RZ:0035%0001.0001.0021)/EUR-Y214-2502GY:0046%@.0003) #Y3_(24-218RZ:0035%0001.0001.0021)/EUR-Y214-2502GY:0046%@.0003#	
  #Y3_((24-218RZ:0035%0001.0001.0021)/EUR-Y214-2502GY:0055%@.0003) #Y3_(24-218RZ:0035%0001.0001.0021)/EUR-Y214-2502GY:0055%@.0003#	
  #Y3_(EUR-Y315-7014GY/EUR-Y214-2502GY:0040%@.0003) #Y3_EUR-Y315-7014GY/EUR-Y214-2502GY:0040%@.0003#
  #Y3_(E23L-2300:0028%0001.) #Y3_E23L-2300:0028%0001.	
  #Y3_(EUR-Y317-5032GY/EURY313-5020GY:0030%0001.) #Y3_EUR-Y317-5032GY/EURY313-5020GY:0030%0001.	
  #Y3_(E23L-2363:0142%0001) #Y3_E23L-2363:0142%0001.	
  #Y3_(E23L-2363:0159%0001) #Y3_E23L-2363:0159%0001.	
  #Y3_(MARBON:0149%0001) #Y3_MARBON:0149%0001.	
  #Y3_(MARBON:0161%0001) #Y3_MARBON:0161%0001.	
  ...
  if((dim(miss3)[1] >0) == TRUE){
    write.csv(miss3,file="/mnt/DH_processing/missing_2021_parents_summer.csv",row.names = FALSE,quote = FALSE)
  }else{
...
finalFileName <- "/mnt/Y3_SummerSeasonDHSet2021_SynthHybrids.tab"
...
geno_format<-function(file){  
  ...
  hybrid_geno <- read.csv(file = "/mnt/Y3_SummerSeasonDHSet2021_SynthHybrids.tab", sep="\t", header=T)
...
dim(geno_wide_ped)
summer_21_train<-geno_wide_ped
save(summer_21_train,file="summer_21_traincuc.Rdata")
